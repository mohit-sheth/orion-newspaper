...
pg = st.navigation(
    [
        st.Page("pages/executive_summary.py", title="Executive Summary", icon=":material/summarize:", default=True),
        st.Page("pages/newspaper.py", title="Newspaper", icon=":material/newspaper:"),
